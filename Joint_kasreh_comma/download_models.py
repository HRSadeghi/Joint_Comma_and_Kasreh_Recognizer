...
def downloader():
    ...
    files = [
        ...
        {"url" : "https://drive.google.com/file/d/1-fNXVGaoTYVXXTUzb5GjDEH_jBt20H8H/view?usp=sharing",
        "output" : join(our_model_ckpt_dir, "best_global_time_1_val_accuracy=0.987.pt")}
    ]
